# Title: point_charge_scan_numerical_template 
...
# forces produced by a point charge perturbation and computed using a central finite difference numerical method.
...
# (i.e. "cp -r point_charge_scan_numerical_template benzene") so that simulations of the molecule are all self-contained within the copied directory.
